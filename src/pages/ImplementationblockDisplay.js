...
const ImplementationblockDisplay = () => {
  ...
  const [implementationblock2, setImplementationblock2] = useState({
    ID: '',
    created_at: '',
    IPQ1: '',
    IPQ2: '',
  ...
  async function fetchImplementationblocks() {
    const { data } = await supabase.from('Implementationcontent').select('*')
  ...
  function displayImplementationblocks(implementationblockID) {
    implementationblocks.map((implementationblock) => {
      if (implementationblock.ID == implementationblockID) {
        setImplementationblock2({
          ID: implementationblock.ID,
          created_at: implementationblock.created_at,
  ...
  async function updateImplementationblocks(implementationblockID) {
    const { data, error } = await supabase
      ...
      .update({
        ID: implementationblock2.ID,
        created_at: implementationblock2.created_at,
        IPQ1: implementationblock2.IPQ1,
        IPQ2: implementationblock2.IPQ2,
        IPQ3: implementationblock2.IPQ3,
        IPQ4: implementationblock2.IPQ4,
        IPQ5: implementationblock2.IPQ5,
        IPQ6: implementationblock2.IPQ6,
        IPQ7: implementationblock2.IPQ7,
      })
  ...
  return (
    <div100>
      <form
        onSubmit={() => updateImplementationblocks(implementationblock2.ID)}
      >
        <Div>
          <Column>
            <Div2>
          ...
          <Column2>
            <Div8>
              ...
              <textarea
                ...
                defaultValue={implementationblock2.IPQ1}
              />
              <Div10>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={implementationblock2.IPQ2}
              />
              <Div11>
                <p>
                  <strong>
                    Do. Commit to execution. Track implementation?
                  </strong>
                </p>
              </Div11>
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={implementationblock2.IPQ3}
              />
              <Div12>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={implementationblock2.IPQ4}
              />
              <Div13>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={implementationblock2.IPQ5}
              />
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={implementationblock2.IPQ6}
              />
              <Div16>
                <p>
                  <strong>
                    {' '}
                    Provide an Action Plan graphic card to show activity
                    progress.
                  </strong>
                </p>
              </Div16>
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={implementationblock2.IPQ7}
              />
            </Div8>
          </Column2>
        </Div>
          ...
          {implementationblocks.map((implementationblock) => (
            <tr key={implementationblock.ID}>
              ...
              <td>
                <button
                  onClick={() => {
                    if (
                      ...
                      deleteImplementationblocks(implementationblock.ID)
                  }}
                >
                  Delete
                </button>
                <button
                  onClick={() => {
                    displayImplementationblocks(implementationblock.ID)
                  }}
                >
                  Edit
                </button>
