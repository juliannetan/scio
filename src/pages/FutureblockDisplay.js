...
const FutureblockPage = () => {
  ...
  const [futureblock2, setFutureblock2] = useState({
    ID: '',
    created_at: '',
    FS1: '',
    FS2: '',
  ...
  function displayFutureblocks(futureblockID) {
    futureblocks.map((futureblock) => {
      if (futureblock.ID == futureblockID) {
        setFutureblock2({
          ID: futureblock.ID,
          created_at: futureblock.created_at,
          FS1: futureblock.FS1,
          FS2: futureblock.FS2,
          FQ1: futureblock.FQ1,
          FQ2: futureblock.FQ2,
  ...
  async function updateFutureblocks(futureblockID) {
    const { data, error } = await supabase
      ...
      .update({
        ID: futureblock2.ID,
        created_at: futureblock2.created_at,
        FS1: futureblock2.FS1,
        FS2: futureblock2.FS2,
        FQ1: futureblock2.FQ1,
        FQ2: futureblock2.FQ2,
        FQ3: futureblock2.FQ3,
        FQ4: futureblock2.FQ4,
        FQ5: futureblock2.FQ5,
        FQ6: futureblock2.FQ6,
      })
          ...
          {futureblocks.map((futureblock) => (
            <tr key={futureblock.ID}>
              ...
              <td>
                <button
                  onClick={() => {
                    if (
                      ...
                      deleteFutureblocks(futureblock.ID)
                  }}
                >
                  Delete
                </button>
                <button
                  onClick={() => {
                    displayFutureblocks(futureblock.ID)
                  }}
                >
                  Edit
                </button>
