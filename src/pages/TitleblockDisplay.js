  ...
  function displayTitleblocks(titleblockID) {
    titleblocks.map((titleblock) => {
      if (titleblock.ID == titleblockID) {
        setTitleblock2({
          ID: titleblock.ID,
          created_at: titleblock.created_at,
  ...
  async function updateTitleblocks(titleblockID) {
    const { data, error } = await supabase
      ...
      .update({
        id: titleblock2.id,
        ID: titleblock2.ID,
        Description: titleblock2.Description,
        ProblemSolvers: titleblock2.ProblemSolvers,
        DecisionMakers: titleblock2.DecisionMakers,
        Implementation: titleblock2.Implementation,
        Assurance: titleblock2.Assurance,
        Delivery: titleblock2.Delivery,
        Organization: titleblock2.Organization,
        Assets: titleblock2.Assets,
        Practice: titleblock2.Practice,
        Value: titleblock2.Value,
        Status: titleblock2.Status,
        TQ1: titleblock2.TQ1,
        TQ2: titleblock2.TQ2,
        TQ3: titleblock2.TQ3,
        TQ4: titleblock2.TQ4,
      ...
      <form onSubmit={() => updateTitleblocks(titleblock2.ID)}>
        <Div2>
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Description}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.ProblemSolvers}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.DecisionMakers}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Implementation}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Assurance}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Delivery}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Organization}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Assets}
          />
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Value}
          />
          <Div14>
          ...
          <textarea
            ...
            required={false}
            onChange={handleChange2}
            defaultValue={titleblock2.Status}
          />
        </Div2>
          ...
          {titleblocks.map((titleblock) => (
            <tr key={titleblock.ID}>
              ...
              <td>
                <button
                  onClick={() => {
                    if (
                      ...
                      deleteTitleblocks(titleblock.ID)
                  }}
                >
                  Delete
                </button>
                <button
                  onClick={() => {
                    displayTitleblocks(titleblock.ID)
                  }}
                >
                  Edit
                </button>
