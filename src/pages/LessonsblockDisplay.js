...
const LessonsblockDisplay = () => {
  ...
  const [lessonsblock2, setLessonsblock2] = useState({
    ID: '',
    created_at: '',
    LLS1: '',
    LLS2: '',
  ...
  function displayLessonsblocks(lessonsblockID) {
    lessonsblocks.map((lessonsblock) => {
      if (lessonsblock.ID == lessonsblockID) {
        setLessonsblock2({
          ID: lessonsblock.ID,
          created_at: lessonsblock.created_at,
  ...
  async function updateLessonsblocks(lessonsblockID) {
    const { data, error } = await supabase
      ...
      .update({
        ID: lessonsblock2.ID,
        created_at: lessonsblock2.created_at,
        LLS1: lessonsblock2.LLS1,
        LLS2: lessonsblock2.LLS2,
        LLQ1: lessonsblock2.LLQ1,
        LLQ2: lessonsblock2.LLQ2,
        LLQ3: lessonsblock2.LLQ3,
        LLQ4: lessonsblock2.LLQ4,
        LLQ5: lessonsblock2.LLQ5,
        LLQ6: lessonsblock2.LLQ6,
      })
            ...
            <Div2>
              <Div3>
                ...
                <textarea
                  ...
                  defaultValue={lessonsblock2.LLS1}
                />
                <Div5>
                  <p>
                ...
                <textarea
                  ...
                  required={false}
                  onChange={handleChange2}
                  defaultValue={lessonsblock2.LLS2}
                />
              </Div3>
            </Div2>
          </Column>
          <Column2>
            <Div8>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={lessonsblock2.LLQ1}
              />
              <Div10>
                <p>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={lessonsblock2.LLQ2}
              />
              <Div11>
                <p>
                  <strong>
                    Audit. Problem-solvers follow process? Decision-makers
                    follow process? Minimize biases? Avoid DQ traps?
                  </strong>
                </p>
              </Div11>
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={lessonsblock2.LLQ3}
              />
              <Div12>
                <p>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={lessonsblock2.LLQ4}
              />
              <Div13>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={lessonsblock2.LLQ5}
              />
              <Div14>
                <p>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={lessonsblock2.LLQ6}
              />
            </Div8>
          </Column2>
        </Div>
          ...
          {lessonsblocks.map((lessonsblock) => (
            <tr key={lessonsblock.ID}>
              ...
              <td>
                <button
                  onClick={() => {
                    if (
                      ...
                      deleteLessonsblocks(lessonsblock.ID)
                  }}
                >
                  Delete
                </button>
                <button
                  onClick={() => {
                    displayLessonsblocks(lessonsblock.ID)
                  }}
                >
                  Edit
                </button>
