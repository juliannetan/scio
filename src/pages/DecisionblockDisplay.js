...
const DecisionblockDisplay = () => {
  ...
  const [decisionblock2, setDecisionblock2] = useState({
    ID: '',
    created_at: '',
    DS1: '',
    DQ1: '',
  ...
  function displayDecisionblocks(decisionblockID) {
    decisionblocks.map((decisionblock) => {
      if (decisionblock.ID == decisionblockID) {
        setDecisionblock2({
          ID: decisionblock.ID,
          created_at: decisionblock.created_at,
          DS1: decisionblock.DS1,
          DQ1: decisionblock.DQ2,
  ...
  async function updateDecisionblocks(decisionblockID) {
    const { data, error } = await supabase
      ...
      .update({
        ID: decisionblock2.ID,
        created_at: decisionblock2.created_at,
        DS1: decisionblock2.DS1,
        DQ1: decisionblock2.DQ2,
        DQ2: decisionblock2.DQ2,
        DQ3: decisionblock2.DQ3,
        DQ4: decisionblock2.DQ4,
        DQ5: decisionblock2.DQ5,
        DQ6: decisionblock2.DQ6,
        DQ7: decisionblock2.DQ7,
      })
            ...
            <Div2>
              <Div3>
                ...
                <textarea
                  ...
                  defaultValue={decisionblock2.DS1}
                />
          ...
          <Column2>
            <Div9>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={decisionblock2.DQ1}
              />
              <Div11>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={decisionblock2.DQ2}
              />
              <Div12>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={decisionblock2.DQ3}
              />
              <Div13>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={decisionblock2.DQ4}
              />
              <Div14>
                <p>
                  <strong>
                    What is our uncertainty? What is our value of Information?
                    Is it worth seeking more knowledge to reduce our
                    uncertainty?
                  </strong>
                </p>
              </Div14>
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={decisionblock2.DQ5}
              />
              <Div15>
                <p>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={decisionblock2.DQ6}
              />
              <Div16>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={decisionblock2.DQ7}
              />
            </Div9>
          </Column2>
        </Div>
          ...
          {decisionblocks.map((decisionblock) => (
            <tr key={decisionblock.ID}>
              ...
              <td>
                <button
                  onClick={() => {
                    if (
                      ...
                      deleteDecisionblocks(decisionblock.ID)
                  }}
                >
                  Delete
                </button>
                <button
                  onClick={() => {
                    displayDecisionblocks(decisionblock.ID)
                  }}
                >
                  Edit
                </button>
