...
const CurrentblockDisplay = () => {
  ...
  const [currentblock2,setCurrentblock2]=useState({
     created_at:'', ID:'', CS1:'', CS2:'', CQ1:'',CQ2:'', CQ3:'', CQ4:'', CQ5:'',CQ6:''
  })
  ...
  function displayCurrentblocks(currentblockID){
    ...
    currentblocks.map((currentblock)=>{
        ...
        if(currentblock.ID==currentblockID){
          ...
          setCurrentblock2({ ID:currentblock.ID, created_at:currentblock.created_at, CS1:currentblock.CS1 , CS2:currentblock.CS2, CQ1:currentblock.CQ1, CQ2:currentblock.CQ2, CQ3:currentblock.CQ3, CQ4:currentblock.CQ4, CQ5:currentblock.CQ5 ,CQ6:currentblock.CQ6 })
        }
   ...
   async function updateCurrentblocks(currentblockID){
    ...
    const { data, error } = await supabase
      ...
      .update({ID:currentblock2.ID, created_at:currentblock2.created_at, CS1:currentblock2.CS1 , CS2:currentblock2.CS2, CQ1:currentblock2.CQ1, CQ2:currentblock2.CQ2, CQ3:currentblock2.CQ3, CQ4:currentblock2.CQ4, CQ5:currentblock2.CQ5 ,CQ6:currentblock2.CQ6})
        ...
        <Column>
          <Div2>
            <Div3>
              ...
              <textarea  name="CS1" required={false} onChange={handleChange2} defaultValue={currentblock2.CS1}/>
              <Div5>Current State Chart / Graphic</Div5>
              <Div6 />
              <Div7>Secondary Current State Statement</Div7>
              <textarea placeholder="" name="CS2" required={false} onChange={handleChange2} defaultValue={currentblock2.CS2}/>
            </Div3>
          </Div2>
        </Column>
        <Column2>
          <Div8>
            ...
            <textarea               
              ...
              name="CQ1"
              required={false}
              onChange={handleChange2} defaultValue={currentblock2.CQ1} />
            <Div10>
            ...
            <textarea               
              ...
              name="CQ2"
              required={false}
              onChange={handleChange2} defaultValue={currentblock2.CQ2}
            />
            <Div11>
            ...
            <textarea               
              ...
              name="CQ3"
              required={false}
              onChange={handleChange2} defaultValue={currentblock2.CQ3}
            />
            ...
            <textarea               
              ...
              name="CQ4"
              required={false}
              onChange={handleChange2} defaultValue={currentblock2.CQ4}
            />
            ...
            <textarea               
              ...
              name="CQ5"
              required={false}
              onChange={handleChange2} defaultValue={currentblock2.CQ5}
            />
            <Div14>
            ...
            <textarea              
              ...
              name="CQ6"
               required={false}
              onChange={handleChange2} defaultValue={currentblock2.CQ6}
            />
