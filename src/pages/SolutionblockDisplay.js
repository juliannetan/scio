...
const SolutionblockDisplay = () => {
  ...
  const [solutionblock2, setSolutionblock2] = useState({
    ID: '',
    created_at: '',
    SEQ1: '',
    SEQ2: '',
  ...
  function displaySolutionblocks(solutionblockID) {
    solutionblocks.map((solutionblock) => {
      if (solutionblock.ID == solutionblockID) {
        setSolutionblock2({
          ID: solutionblock.ID,
          created_at: solutionblock.created_at,
  ...
  async function updateSolutionblocks(solutionblockID) {
    const { data, error } = await supabase
      ...
      .update({
        ID: solutionblock2.ID,
        created_at: solutionblock2.created_at,
        SEQ1: solutionblock2.SEQ1,
        SEQ2: solutionblock2.SEQ2,
        SEQ3: solutionblock2.SEQ3,
        SEQ4: solutionblock2.SEQ4,
        SEQ5: solutionblock2.SEQ5,
        SEQ6: solutionblock2.SEQ6,
        SEQ7: solutionblock2.SEQ7,
      })
          ...
          <Column2>
            <Div12>
              ...
              <textarea
                ...
                defaultValue={solutionblock2.SEQ1}
              />
              <Div14>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={solutionblock2.SEQ2}
              />
              <Div15>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={solutionblock2.SEQ3}
              />
              <Div16>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={solutionblock2.SEQ4}
              />
              <Div17>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={solutionblock2.SEQ5}
              />
              <Div18>
                <p>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={solutionblock2.SEQ6}
              />
              <Div19>
                <p>
                  <strong>
              ...
              <textarea
                ...
                required={false}
                onChange={handleChange2}
                defaultValue={solutionblock2.SEQ7}
              />
            </Div12>
          </Column2>
        </Div>
          ...
          {solutionblocks.map((solutionblock) => (
            <tr key={solutionblock.ID}>
              ...
              <td>
                <button
                  onClick={() => {
                    if (
                      ...
                      deleteSolutionblocks(solutionblock.ID)
                  }}
                >
                  Delete
                </button>
                <button
                  onClick={() => {
                    displaySolutionblocks(solutionblock.ID)
                  }}
                >
                  Edit
                </button>
