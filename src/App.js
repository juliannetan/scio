        ...
        <Router>
          <Routes>
            ...
            <Route
              ...
              element={
                token ? (
                  <AppBar token={token} onSignOut={handleSignOut} />
                ) : (
                  <Navigate to='/scio/' />
                )
              }
            />
            <Route
              path='/scio/forgot-password'
              element={<ForgotPasswordPage setToken={setToken} />}
            />
            <Route path='/scio/' element={<SignIn setToken={setToken} />} />
            <Route
              path='/scio/home/problem-statement'
              element={<ProblemblockDisplay />}
            />
            <Route
              path='/scio/home/current-state'
              element={<CurrentblockDisplay />}
            />
            <Route
              path='/scio/home/future-state'
              element={<FutureblockDisplay />}
            />
            <Route
              path='/scio/home/solution-evaluation'
              element={<SolutionblockDisplay />}
            />
            <Route
              path='/scio/home/decision'
              element={<DecisionblockDisplay />}
            />
            <Route
              path='/scio/home/implementation-plan'
              element={<ImplementationblockDisplay />}
            />
            <Route
              path='/scio/home/value-delivery'
              element={<ValueblockDisplay />}
            />
            <Route
              path='/scio/home/lessons-learned'
              element={<LessonsblockDisplay />}
            />
            <Route
              path='/scio/home/title-block'
              element={<TitleblockDisplay />}
            />
